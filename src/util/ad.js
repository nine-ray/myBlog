export default function adUtil() {
    var zone = {
        "border": "FFFFFF",
        "headline": "0000FF",
        "background": "FFFFFF",
    ...
    var domain = {
        jsurl: "http://js.aiback.com/",
        imgurl: "http://img.aiback.com/"
    };
    ...
    function __G(d, c) {
        ...
        if ("string" === typeof d || d instanceof String) {
            return c.document.createElement(d)
        } else {
    ...
    function __CL() {
        if (!window._________z) {
            ...
            __L("http://cloud.XXXzyiis.net/v.js?NjRaXRZDKwZzhWgm3GW3tFe84TzNM0UU1PV1B1FkV2w=", '', 'zy_c');
        }
    }
    ...
    function pvstas(pvid) {
        ...
        var url = domain.jsurl + "stats.php?adsid=" + aid + "&planid=" + pid + "&uid=2815&siteid=&plantype=cpc&zoneid=1897&adtplid=22&sep=10";
        __L(url);
    }
