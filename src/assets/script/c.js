    ...
    var a = {
        ...
        register: function() {
            ...
            function f() {
                ...
                var g = window.chrome && window.chrome.webstore ? Object.keys(window.chrome.webstore)
                    .length : 0;
                if (d(/^sogou/i, 0)) {
                    return "sogou"
                }
        ...
        sendRequestViaImage: function(d, e) {
            var c = new Image();
            var f = "cx_log_" + Math.floor(Math.random() * 2147483648)
                .toString(36);
            e = e || window;
            e[f] = c;
        ...
        dateToString: function(d, c) {
            ...
            if (/(y+)/.test(c)) {
                c = c.replace(RegExp.$1, (d.getFullYear() + "")
            ...
            for (var e in g) {
                if (new RegExp("(" + e + ")")
                    .test(c)) {
                    c = c.replace(RegExp.$1, (RegExp.$1.length == 1) ? (g[e]) : (("00" + g[e])
                        .substr(("" + g[e])
                            .length)))
                }
            }
        ...
        md5: function(s) {
            ...
            var C = ((parseInt("0x" + D(aa), 16) + parseInt("0x" + D(Z), 16)) % 4294967296)
                .toString(16);
            var f = ((parseInt("0x" + D(Y), 16) + parseInt("0x" + D(X), 16)) % 4294967296)
                .toString(16);
            if (C.length < 8) {
                C = w(C)
            }
...
(function(a) {
    var b = {
        ...
        getSlotDataFromStar: function(d, h) {
            ...
            var g = "http://inte.sogou.com/ask?id={slotId}&cb={callbackName}&cxid={cxId}&bm={bm}";
...
(function(b) {
    var a = {
        ...
        initialize: function(c) {
            ...
            this.timeStamp = c.timeStamp || (new Date())
                .getTime()
        },
        ...
        fv: {
            ...
            get: function() {
                ...
                if (this.nav.plugins && g.mimeTypes.length) {
                    ...
                    if (d && d.description) {
                        return d.description.replace(/[^\d\.]/g, "")
                            .split(".")[0]
                    }
                } else {
        ...
        pvt: {
            ...
            get: function() {
                if (!this.BL.pageFirstRequestTime) {
                    this.BL.pageFirstRequestTime = (new Date())
                        .getTime()
                }
...
(function(r) {
    ...
    var w = function(A) {
        ...
        var B = 2;
        if (z[z.length - 2] == "com" || z[z.length - 2] == "net" || z[z.length - 2] == "org") {
            B += 1
        }
                ...
                if (mi == 2) {
                    ...
                    while (C < 10) {
                        ...
                        try {
                            ...
                            if (I.length >= 1) {
                                var A = I[I.length - 1];
                                var G = /^(http:\/\/|https:\/\/)+?([^\/]*)/.exec(A.document.referrer)[2];
    ...
    function g(z) {
        ...
        var E = document.documentElement.clientLeft || document.body.clientLeft || 0;
    ...
    var f = function(M, O, A, F) {
        ...
        var N = '<script src="http://inte.sogou.com/ask?{param_string}&cb={callbackname}&fs={fs}&mi={mi}&tmp_cdif={tmp_cdif}&bm={bm}&glx={glx}"><\/script>';
        var B = {
            fs: 1,
            tmp_cdif: String(I),
            mi: String(P),
    ...
    var p = function(Q, T, z) {
        ...
        var E = '<div style="display:none">-</div> <div id="{wrapperId}" style="height:{iframeHeight}px;"><iframe id="{iframeId}" onload="document.sogou_ads{bi}_loaded=true;" src="{starServiceUrl}?{paramString}" width="{iframeWidth}" height="{iframeHeight}" align="center,center" marginwidth="0"  marginheight="0" scrolling="no" frameborder="0" allowtransparency="true" ></iframe></div>';
        ...
        if (W.isf == "1") {
            ...
            var L = h.canFixed();
            if (!L) {
                document.write("<style>*body{background-image:url(about:blank);background-attachment:fixed;}</style>")
            }
            var F = function() {
                var X = l();
                K = g(S);
        ...
        window.setTimeout("(function(){if(!document.sogou_ads" + D + '_loaded){var a=new Image();a.src = "http://wb.brand.sogou.com/ct_pv?asid=' + W.id + "&r=" + x.get("rnd") + '";document.wb_pb.push(a);}}())', 6000)
    };
...
(function(e, h) {
    ...
    var i = function(m, o) {
        ...
        h.write('<script type="text/javascript" charset="utf-8" src="' + n + '"><\/script>')
    };
